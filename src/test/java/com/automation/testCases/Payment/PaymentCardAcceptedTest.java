...
public class PaymentCardAcceptedTest extends BaseTest {
    ...
    public Object[][] getDataFulfilledPayment() {
        return new Object[][] {
                { "SE", "Required", "3D Secure 2 reg. authentication", "algot@android1.com", "123123123", "4000 0000 0000 3220", choose3ds.Confirm, cardStatus.Card_succeed},
                { "SE",  "Required", "3D Secure req. authentication", "algot@android2.com", "123123123", "4000 0000 0000 3063", choose3ds.Confirm, cardStatus.Card_succeed},
                { "SE",  "Supported", "3D Secure not req. authenticatio", "algot@android3.com", "123123123", "4000 0000 0000 3055", choose3ds.No3dVerification, cardStatus.Card_succeed},
                { "SE", "Supported", "Card is not enrolled in 3D Secure.", "algot@android4.com", "123123123", "4242 4242 4242 4242", choose3ds.No3dVerification, cardStatus.Card_succeed},
                { "SE", "notSuppored", "3D Secure is not supported", "algot@android5.com", "123123123", "378282246310005", choose3ds.No3dVerification, cardStatus.Card_succeed}
        };
    }
}
